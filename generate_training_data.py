...
for _ in tqdm(range(500)):
    try:
        agent0 = MCTSAgent(simulation_time=3,  training_path="./data/training_neural_pipo.npy")
        agent1 = MCTSAgent(simulation_time=3,  training_path="./data/training_neural_pipo.npy")
